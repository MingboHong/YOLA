...
load_from = 'https://download.openmmlab.com/mmdetection/v3.0/yolo/yolov3_d53_mstrain-608_273e_coco/yolov3_d53_mstrain-608_273e_coco_20210518_115020-a2c3acb8.pth'
...
model = dict(
    ...
    loss_consistency=dict(
        loss_weight=10.0, reduction='sum', type='SmoothL1Loss'),
